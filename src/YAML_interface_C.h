...
extern "C" {
	...
	*/
	...
	<CODE>
	<PRE>
	status = YAMLScreenMessage(id, "Beginning to process YAML for initial conditions");
	</PRE>
	</CODE>
	@endhtmlonly
	*/
	...
	*/
	...
	@param id           The instance id returned from @ref CreateYAMLPhreeqcRM.
	@param tf           1, enable error messages; 0, disable error messages. Default is 1.
	@retval IRM_RESULT  Zero indicates success, negative indicates failure.
	...
	*/
	...
	@param id          The instance id returned from @ref CreateYAMLPhreeqcRM.
	@param tf          1, enable screen messages; 0, disable screen messages. Default is true.
	@retval IRM_RESULT Zero indicates success, negative indicates failure.
