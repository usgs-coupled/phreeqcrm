...
'Provides a mapping from grid cells in the user model to reaction cells for which chemistry needs to be run.
...
The number of reaction cells is less than or equal to the number of grid cells in the user model.
Returns:
...
'Returns the number of grid cells in the user model, which is defined in
...
Returns:
	const DoubleVector: A vector reference to the pore volumes.
		Size of vector is @a nxyz, the number of grid cells in the user model (:meth: `GetGridCellCount`).'
%enddef
...
Returns:
	IntVector: Vector of integers. Size of vector is @a nxyz, where @a nxyz is the number
		of grid cells in the user model (:meth: `GetGridCellCount`). A value of 0 for a cell indicates
...
Args:
	so (DoubleVector): A vector to contain the selected-output values.
		...
		and @a nxyz is the number of grid cells in the user model (:meth: `GetGridCellCount`).
Returns:
	IRM_RESULT: 0 is success, negative is failure (See :meth: `DecodeError`).'
%enddef
...
@a Initial_conditions1 is dimensioned 7 times @a nxyz, where @a nxyz is the number of grid cells in the user model
...
Args:
	initial_conditions1 (int list, numpy.ndarray, or tuple): Vector of solution and reactant index numbers that refer to
		definitions in the InitialPhreeqc instance.
		Size is 7 times @a nxyz, where @a nxyz is the number of grid cells in the user model (:meth: `GetGridCellCount`).
...
Args:
	...
	cell_numbers (int): A vector of grid-cell numbers (user grid-cell numbering system) that
...
Args:
	c (double list, numpy.ndarray, or tuple): Component concentrations. Size of vector is @a ncomps times @a nxyz,
		...
		@a nxyz is the number of grid cells in the user model (:meth: `GetGridCellCount`).
Returns:
	IRM_RESULT: 0 is success, negative is failure (See :meth: `DecodeError`).'
%enddef
...
Args:
	p (float list, numpy.ndarray, or tuple): Pressures, in atm. Size of vector is @a nxyz,
		where @a nxyz is the number of grid cells in the user model (:meth: `GetGridCellCount`).
Returns:
	IRM_RESULT: 0 is success, negative is failure (See :meth: `DecodeError`).'
%enddef
...
Args:
	cell_mask (IntVector): Vector of integers. Size of vector is @a nxyz, where @a nxyz is the number
		of grid cells in the user model (:meth: `GetGridCellCount`). A value of 0 will
