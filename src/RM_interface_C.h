...
strcpy_s(str, MAX_LENGTH, "SELECTED_OUTPUT 5; -pH; RUN_CELLS; -cells 1");
...
strcpy_s(str1, MAX_LENGTH, "File prefix: ");
strcat_s(str1, MAX_LENGTH, str);
strcat_s(str1, MAX_LENGTH, "\n");
...
<CODE>
<PRE>
strcat_s(input, MAX_LENGTH, "  -gases\n");
...
<CODE>
<PRE>
strcat_s(input, MAX_LENGTH, "  -kinetics\n");
...
<CODE>
<PRE>
strcat_s(input, MAX_LENGTH, "  -saturation_indices\n");
...
IRM_DLL_EXPORT IRM_RESULT RM_GetSIName(int id, int num, char *name, int l1);
 ...
 <CODE>
 <PRE>
 strcat_s(input, MAX_LENGTH, "  -solid_solutions\n");
...
<CODE>
<PRE>
strcpy_s(str, MAX_LENGTH, "DELETE; -all");
