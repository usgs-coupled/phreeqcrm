...
<CODE>
<PRE>
areas = (double *) malloc((size_t) (nxyz * sizeof(double)));
...
for (i = 0; i < count_surface; i++)
{
	...
	status = RM_GetSurfaceDiffuseLayerArea(id, surfaces[i], areas);
}
</PRE>
</CODE>
@endhtmlonly
...
<CODE>
<PRE>
dl_species_conc = (double *) malloc((size_t) (nspecies * nxyz * sizeof(double)));
count_surface = RM_GetSurfaceDiffuseLayerCount(id);
surfaces = (char **) malloc((size_t) count_surface);
for (i = 0; i < count_surface; i++)
{
...
Called by root, workers must be in the loop of @ref RM_MpiWorker.
 */
IRM_DLL_EXPORT IRM_RESULT RM_GetSurfaceDiffuseLayerConcentrations(int id, char *surf, double * dl_species_conc);
/**
...
<PRE>
count_surface = RM_GetSurfaceDiffuseLayerCount(id);
surf_name = (char **) malloc((size_t) count_surface);
for (i = 0; i < count_surface; i++)
{
  surf_name[i] = (char *) malloc(100);
  status = RM_GetSurfaceDiffuseLayerName(id, i, surf_name[i], 100);
}
</PRE>
</CODE>
@endhtmlonly
...
<CODE>
<PRE>
thickness = (double *) malloc((size_t) (nxyz * sizeof(double)));
count_surface = RM_GetSurfaceDiffuseLayerCount(id);
surfaces = (char **) malloc((size_t) count_surface);
for (i = 0; i < count_surface; i++)
{
	surfaces[i] = (char *) malloc(100);
	status = RM_GetSurfaceDiffuseLayerName(id, i, surfaces[i], 100);
	status = RM_GetSurfaceDiffuseLayerThickness(id, surfaces[i], thickness);
}
</PRE>
</CODE>
@endhtmlonly
