...
IRM_DLL_EXPORT IRM_RESULT WriteYAMLDoc_F(int* id, char* file_name);
...
IRM_DLL_EXPORT IRM_RESULT YAMLLoadDatabase_F(int* id, char* database);
IRM_DLL_EXPORT IRM_RESULT YAMLLogMessage_F(int* id, char* str);
IRM_DLL_EXPORT IRM_RESULT YAMLOpenFiles_F(int* id);
IRM_DLL_EXPORT IRM_RESULT YAMLOutputMessage_F(int* id, char* str);
IRM_DLL_EXPORT IRM_RESULT YAMLRunCells_F(int* id);
IRM_DLL_EXPORT IRM_RESULT YAMLRunFile_F(int* id, bool* workers, bool* initial_phreeqc,
							bool* utility, char* file_name);
IRM_DLL_EXPORT IRM_RESULT YAMLRunString_F(int* id, bool* workers, bool* initial_phreeqc,
							bool* utility, char* input_string);
IRM_DLL_EXPORT IRM_RESULT YAMLScreenMessage_F(int* id, char* str);
IRM_DLL_EXPORT IRM_RESULT YAMLSetComponentH2O_F(int* id, bool* tf);
...
IRM_DLL_EXPORT IRM_RESULT YAMLSetDumpFileName_F(int* id, char* dump_name);
IRM_DLL_EXPORT IRM_RESULT YAMLSetErrorHandlerMode_F(int* id, int* mode);
IRM_DLL_EXPORT IRM_RESULT YAMLSetErrorOn_F(int* id, bool* tf);
IRM_DLL_EXPORT IRM_RESULT YAMLSetFilePrefix_F(int* id, char* prefix);
...
IRM_DLL_EXPORT IRM_RESULT YAMLSetPartitionUZSolids_F(int* id, bool* tf);
...
IRM_DLL_EXPORT IRM_RESULT YAMLSetPrintChemistryOn_F(int* id, bool* workers, bool* initial_phreeqc,
							bool* utility);
IRM_DLL_EXPORT IRM_RESULT YAMLSetRebalanceByCell_F(int* id, bool* tf);
...
IRM_DLL_EXPORT IRM_RESULT YAMLSetScreenOn_F(int* id, bool* tf);
IRM_DLL_EXPORT IRM_RESULT YAMLSetSelectedOutputOn_F(int* id, bool* tf);
IRM_DLL_EXPORT IRM_RESULT YAMLSetSpeciesSaveOn_F(int* id, bool* save_on);
...
IRM_DLL_EXPORT IRM_RESULT YAMLUseSolutionDensityVolume_F(int* id, bool* tf);
IRM_DLL_EXPORT IRM_RESULT YAMLWarningMessage_F(int* id, char* warnstr);
