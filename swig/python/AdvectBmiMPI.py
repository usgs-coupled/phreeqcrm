...
def AdvectBmiMPI():
	...
	ntasks = bmi.GetMpiTasks()

	print(f"Number of MPI processes:                          {ntasks}")
	...
	print(f"Number of chemistry cells:                        {nchem}")
...
def WriteYAMLFile(file_prefix, nxyz):
